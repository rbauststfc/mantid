...
void MainWindowPresenter::notifyChangeInstrumentRequested(std::string const &newInstrumentName) {
  onInstrumentSelected(newInstrumentName);
}
...
void MainWindowPresenter::initNewBatch(IBatchPresenter *batchPresenter, std::string const &instrument,
  ...
  onInstrumentSelected(selectedInstrument, batchPresenter);
...
void MainWindowPresenter::onInstrumentSelected(std::string const &selectedInstrument, IBatchPresenter *batchPresenter) {
